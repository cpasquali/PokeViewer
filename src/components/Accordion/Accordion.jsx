  ...
  return (
    ...
    <div class="accordion-item">
      ...
      <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
        <div class="accordion-body">El despliegue del proyecto fue realizado a traves de Vercel, se utilizo el controlador de versiones llamado Git y el repositorio del mismo lo podes encontrar en el siguiente enlace el cual te redirigira a GitHub <a target='_blank' href="https://github.com/cpasquali/PokeViewer">Click al repo</a></div>
      </div>
    </div>
  </div>
  )
